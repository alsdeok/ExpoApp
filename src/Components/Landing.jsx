...
export default function Landing() {
  ...
  return (
    <div>
      ...
      <Carousel className="bg-[#282c34] min-h-screen border-b">
        {videos.map((video, index) => {
          return (
            <div key={index}>
              <div className="relative min-h-screen w-full flex flex-col gap-10 items-center place-content-center">
                ...
                {estadoDiv ? (
                  <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/90">
                    <div className="w-3/4 text-center md:w-2/4">
                      ...
                      <button
                        className="inline-block text-white rounded border-2 border-neutral-50 px-6 pb-[6px] pt-2 mt-4 text-md font-semibold uppercase leading-normal hover:bg-gray-100 text-neutral-50 transition duration-150 ease-in-out hover:border-neutral-100 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-neutral-100 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
